...
import com.boot.jwt.core.key.HMACKeystore;
...
public class JJwtServiceImplTest {
    ...
    public void generateToken_typicalHMAC() throws Exception {
        ...
        JJwtServiceImpl jjwtServiceImpl = JJwtServiceImpl.JwtServiceBuilder.getInstance()
                .appName(APP_NAME)
        ...
        String rstToken = jjwtServiceImpl.generateToken(ImmutableMap.of(KEY, RANDOM_VALUE));
    ...
    public void jwtSericeBuilder_noapplicationName() throws Exception {
        ...
        JJwtServiceImpl.JwtServiceBuilder.getInstance()
                .instanceId(APP_NAME + 1)
                .algo(HMAC)
                .build();
    ...
    public void paserJwt_Expired_hmac() throws Exception {
        ...
        jjwtServiceImpl.paserJwt(JWT_TOKEN_EXPIRED_HMAC);
    }
    ...
    public void paserJwt_typicalHMAC() throws Exception {
        ...
        JJwtServiceImpl jjwtServiceImpl = JJwtServiceImpl.JwtServiceBuilder.getInstance()
                ...
                .keystore(hmacKeystore)
                .build();
        String generatedToken = jjwtServiceImpl.generateToken(ImmutableMap.of(KEY, RANDOM_VALUE));


        Jwt<Header, Claims> headerClaimsJwt = JJwtServiceImpl.JwtServiceBuilder.getInstance()
                .appName(APP_NAME)
                .instanceId(APP_NAME + 1)
                .algo(HMAC)
                .signingKeyResolver(mockKeyResolver)
    ...
    public void paserJwt_ExpiredRSA() throws Exception {
        ...
        Jwt<Header, Claims> claimsJwt = jjwtServiceImpl.paserJwt(JWT_TOKEN_EXPIRED_RSA);
    }
